...
import edu.unicauca.descriptor_media_stcav.logic.ProgrammeProcessorServerGenerator;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		ManRes programmeProcessorServer = ProgrammeProcessorServerGenerator.do_create_man_res();
		...
		ParserXML.document_to_single_xml_myMBeanInfo(mmrs);
		mmrs.clear();
		mmrs.add(SkeletonProcessor.do_ManRes_to_myManRes(programmeProcessorServer));
		ParserXML.document_to_single_xml_myMBeanInfo(mmrs);
